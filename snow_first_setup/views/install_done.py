...
@Gtk.Template(resource_path="/org/frostyard/FirstSetup/gtk/install-done.ui")
class VanillaInstallDone(Adw.Bin):
    __gtype_name__ = "VanillaInstallDone"
    ...
    def set_page_active(self):
        ...
        self.btn_reboot.grab_focus()

    def set_page_inactive(self):
        return

    def __on_reboot_clicked(self, *args):
        subprocess.Popen(["/usr/bin/systemctl", "reboot"], stdout=subprocess.DEVNULL, stderr=subprocess.DEVNULL, stdin=subprocess.DEVNULL, start_new_session=True)
        self.__window.close()
