...
from tunaos_first_setup.views.locations import VanillaLocation

import tunaos_first_setup.core.keyboard as kbd
import tunaos_first_setup.core.timezones as tz
import tunaos_first_setup.core.backend as backend

_ = __builtins__["_"]

@Gtk.Template(resource_path="/org/tunaos/FirstSetup/gtk/keyboard.ui")
