...
@Gtk.Template(resource_path="/org/tunaos/FirstSetup/gtk/theme.ui")
class VanillaTheme(Adw.Bin):
    ...
    def __set_wallpaper_assets(self):
        ...
        try:
            ...
            default_pixbuf = GdkPixbuf.Pixbuf.new_from_resource("/org/tunaos/FirstSetup/assets/background_replacement.png")
