...
from tunaos_first_setup.dialog import VanillaDialog

_ = __builtins__["_"]

@Gtk.Template(resource_path="/org/tunaos/FirstSetup/gtk/window.ui")
class VanillaWindow(Adw.ApplicationWindow):
    ...
    def __build_ui(self, configure_system_mode: bool, install_mode: bool):
        ...
        if configure_system_mode:
            from tunaos_first_setup.views.welcome import VanillaWelcome
            if self.oem_mode:
                ...
                from tunaos_first_setup.views.timezone import VanillaTimezone
            from tunaos_first_setup.views.conn_check import VanillaConnCheck
            from tunaos_first_setup.views.hostname import VanillaHostname
            from tunaos_first_setup.views.user import VanillaUser
            from tunaos_first_setup.views.core_progress import VanillaCoreProgress

            from tunaos_first_setup.views.logout import VanillaLogout
            ...
            from tunaos_first_setup.views.welcome_user import VanillaWelcomeUser
            from tunaos_first_setup.views.conn_check import VanillaConnCheck
            from tunaos_first_setup.views.theme import VanillaTheme
            from tunaos_first_setup.views.applications import VanillaLayoutApplications
            from tunaos_first_setup.views.progress import VanillaProgress
            from tunaos_first_setup.views.done import VanillaDone
